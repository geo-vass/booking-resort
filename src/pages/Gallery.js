...
const Gallery = ({ gallery, toggleGallery }) => {
  ...
  return (
    ...
    >
      <div className="grid gap-4 md:grid-cols-5 md:grid-rows-[150px_150px] ">
        <div className="md:col-span-3 col-span-3 row-span-2  h-full">
          ...
          if (index === maxPics - 1) {
            return (
              <div className="relative" key={index}>
                <div
                  className="absolute  left-[50%] bottom-[0%] translate-x-[-50%]  z-10 bg-slate-900/40 p-2 w-full h-full translate-y-[0%] cursor-pointer flex items-center justify-center rounded-md"
